...
class ConfigUpdateForm(flask_wtf.FlaskForm):
  ...
  trusted_hosts = wtforms.StringField(model.Config.trusted_hosts._verbose_name, [wtforms.validators.optional()], description='Comma separated: 127.0.0.1, my-domain.com, etc')
...
def admin_config():
  ...
  if form.validate_on_submit():
    ...
    if not form.trusted_hosts.data:
      form.trusted_hosts.data = flask.request.host
