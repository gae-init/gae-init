...
class AuthUpdateForm(flask_wtf.FlaskForm):
  ...
  twitch_client_id = wtforms.StringField(model.Config.twitch_client_id._verbose_name, filters=[util.strip_filter])
  twitch_client_secret = wtforms.StringField(model.Config.twitch_client_secret._verbose_name, filters=[util.strip_filter])
